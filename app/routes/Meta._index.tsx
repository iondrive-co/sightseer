        ...
        <div className="app">
            ...
            <main id="main-content" className="main-container">
                <div className="max-w-4xl mx-auto px-8 py-12">
                    <h1 className="sr-only">About Iondrive</h1>
                    <section aria-labelledby="about-heading">
                        <h2 id="about-heading" className="text-2xl font-semibold mb-4">About</h2>
                    ...
                    <section aria-labelledby="colophon-heading">
                        <h2 id="colophon-heading" className="text-2xl font-semibold mb-4">Colophon</h2>
                    ...
                    <footer className="border-t pt-8 mt-12">
                        <p className="text-sm text-gray-600">
                            Miles, <time dateTime={new Date().toISOString().slice(0, 10)}>{new Date().toLocaleDateString('en-US', {
                            month: 'long',
                            day: 'numeric',
                            year: 'numeric'
                        })}</time>
