...
in 12 BFC, it has been republished twice to cover the post [[First Contact Event]] environment, with the latest edition 
coming out in 15 AFC. KOTA is largely focussed on how the environment has shaped off Earth societies, and how changing 
...
The first model covers the period from the first lunar settlement through the [[Khan Solar Storm]] until the first of 
the new generation settlements like [[Dao Vallis Outpost~Hellas Planitia]]. Diallo calls this the hyper-social period, 
where the kind of individualism common on Earth was unable to withstand the close quarters and distance from any 
immediate help and thus acted as a strong selection pressure for colonists who valued cooperation and communal living. 
The focus on research and development rather than economic development in the early colonies led to a heavy skew towards 
scientists and engineers, and several examples are given of this affecting the world view and politics present in these 
societies. Differences between the colonies of various nations and corporations lead to a wide variety of living, 
co-parenting, and synthetic reproduction arrangements, conditions which Diallo calls the laboratory of mankind. There 
were still some common cultural elements that developed across most of the colonies, the model gives evidence for common 
attitudes to the prioritization of match making for young people, less tolerance of alternative living arrangements that 
didn't produce offspring, and more acceptance of non-conventional structures such as line marriage which did.
...
this time many colonies had significant divergences from their founding societies, Diallo describes them as being both
snapshots of previous eras on Earth and as cross-pollinated fruits developing their own distinct characteristics.
